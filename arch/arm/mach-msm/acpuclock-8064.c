...
#ifdef CONFIG_SHADYCLOCKS // CONFIG_SHADYCLOCKS defined
...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[0]  = { {  276000, HFPLL, 2, 0x1C },  950000, 1050000, 1 },
...
static struct acpu_level tbl_ShadyClocks[] __initdata = {
	...
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(14), 1100000 },
	{ 1, {  1998000, HFPLL, 1, 0x46 }, L2(14), 1125000 },
	{ 1, {  2052000, HFPLL, 1, 0x46 }, L2(14), 1150000 },
	#else
...
#else // CONFIG_SHADYCLOCKS not defined
...
#endif
#endif
#endif // end #ifdef CONFIG_SHADYCLOCKS

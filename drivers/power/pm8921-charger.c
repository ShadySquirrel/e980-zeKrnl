...
#define ADAPTIVE_NUM_OF_TABLE                   (8)
static int ADAPTIVE_MA_TABLE[ADAPTIVE_NUM_OF_TABLE] = { 500, 600, 700, 800, 900, 1100, 1200, 1300};
static int ADAPTIVE_MA_TABLE_CHARGERLOGO[] = { 500, 600, 700, 800, 900, 1100, 1200, 1300 };
...
#define ADAPTIVE_USB_CURRENT_DROP_CHECK_MS	(100)
#define CHARGING_COLLAPSE_VOLTAGE		4580
#define ADAPTIVE_NUM_OF_TABLE                   (10)
static int ADAPTIVE_MA_TABLE[ADAPTIVE_NUM_OF_TABLE] = { 500, 600, 700, 800, 900, 1100, 1200, 1300, 1400, 1500 };
static int ADAPTIVE_MA_TABLE_CHARGERLOGO[] = { 500, 600, 700, 800, 900, 1100, 1200, 1300, 1400, 1500 };
